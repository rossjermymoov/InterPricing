...
<div class="panel" id="customersPanel">
  ...
  <div style="display:flex;gap:28px;flex-wrap:wrap;margin-top:16px;border-top:1px dashed var(--line);padding-top:16px">
    ...
    <div style="flex:1;min-width:260px">
      <div class="f"><label>Card title</label><input id="rcTitle" type="text" value="International Rate Card" style="width:100%"/></div>
      <div class="f" style="margin-top:12px"><label>Notes to customer (optional)</label><textarea id="rcNotes" rows="2" style="width:100%" placeholder="e.g. Prices valid for 30 days."></textarea></div>
