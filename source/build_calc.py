...
<div class="adminnote">Markups apply to carrier cost (base + fuel). "Cost" = your internal uplift; "Sell" = charge-out to the customer. Fuel is fixed in the background (DPD 18%; UPS Express 46.25% &amp; Standard 29% list, both ×0.75 for your 25% discount, passed on to the customer).</div>
<div class="mkgrid">
  <div class="grp"><h3>DPD Road<br><span style="font-weight:400;text-transform:none;color:var(--muted)">Classic Parcel &amp; ExpressPak</span></h3>
    <div class="pair"><div class="f"><label>Cost %</label><input id="mkRoadCost" type="number" step="0.5" value="6"/></div>
      <div class="f"><label>Sell %</label><input id="mkRoadSell" type="number" step="0.5" value="12"/></div></div></div>
  <div class="grp"><h3>DPD Air<br><span style="font-weight:400;text-transform:none;color:var(--muted)">Classic Air &amp; Air Express</span></h3>
    <div class="pair"><div class="f"><label>Cost %</label><input id="mkAirCost" type="number" step="0.5" value="12"/></div>
      <div class="f"><label>Sell %</label><input id="mkAirSell" type="number" step="0.5" value="18"/></div></div></div>
  <div class="grp"><h3>UPS<br><span style="font-weight:400;text-transform:none;color:var(--muted)">Express Saver &amp; Standard</span></h3>
    <div class="pair"><div class="f"><label>Cost %</label><input id="mkUpsCost" type="number" step="0.5" value="0"/></div>
      <div class="f"><label>Sell %</label><input id="mkUpsSell" type="number" step="0.5" value="30"/></div></div></div>
</div>
</details>
...
const FUEL={dpd:18, upsx:46.25*0.75, upss:29*0.75};   // effective % (UPS ×0.75 for 25% off, passed to customer)
...
['country','wt','L','W','H','metric','mkRoadCost','mkRoadSell','mkAirCost','mkAirSell','mkUpsCost','mkUpsSell'].forEach(id=>$(id).addEventListener('input',calc));
